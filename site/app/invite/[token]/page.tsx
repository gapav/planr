...
export default function InvitePage() {
  const { token } = useParams<{ token: string }>(); const router = useRouter(); const { user, isDemoMode, refreshWorkspace } = useGrep(); const [remoteStatus, setRemoteStatus] = useState<"loading" | "accepted" | "error">("loading"); const [remoteMessage, setRemoteMessage] = useState("Accepting your team invitation…");
