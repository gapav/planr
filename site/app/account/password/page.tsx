...
export default function ChangePasswordPage() {
  const { user, setPassword } = useGrep(); const router = useRouter(); const [password, setNewPassword] = useState(""); const [confirmation, setConfirmation] = useState(""); const [loading, setLoading] = useState(false); const [error, setError] = useState<string | null>(null);
