...
const nav = [
  ...
  { href: "/team", label: "Lag og spillere", icon: Settings },
];
// Only the platform owner administers teams, and they reach every team from
// here rather than through the switcher — the teams they created are not theirs
